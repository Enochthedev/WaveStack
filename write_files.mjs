...
const viewerData = [
  ...
  { date: "Feb 22", youtube: 8200, twitch: 3400, tiktok: 2300 },
];

const engagementData = [
  { date: "Feb 15", rate: 4.1 },
  { date: "Feb 16", rate: 3.8 },
  { date: "Feb 17", rate: 5.2 },
  { date: "Feb 18", rate: 4.7 },
  { date: "Feb 19", rate: 4.4 },
  { date: "Feb 20", rate: 5.8 },
  { date: "Feb 21", rate: 5.5 },
  { date: "Feb 22", rate: 6.1 },
];
...
const platformData = [
  ...
  { platform: "Twitter", views: 7000, followers: 310 },
];
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Last 8 days across YouTube, Twitch, and TikTok</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="space-y-3">
            {topContent.map((item) => (
              ...
              >
                ...
                <span className="text-sm font-medium text-green-600">{item.engagement}</span>
              </div>
            ))}
          </div>
        </CardContent>

...
export function Companion() {
  ...
  const panelLeft = !mounted
    ? 0
    : clamp(pos.x + BTN - PANEL_W, MARGIN, window.innerWidth - PANEL_W - MARGIN);
  ...
  const actions =
    Object.entries(contextActions).find(
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <div className={cn("relative flex items-center gap-3 px-4 py-3 shrink-0", brand.bg)}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-white/70 truncate">
                Your AI Companion · All platforms
              </p>
            </div>
              ...
              {messages.map((msg) => (
                ...
                >
                  {msg.role === "assistant" && (
                    <div
                      className={cn(
                        "flex h-6 w-6 shrink-0 items-center justify-center rounded-full mr-2 mt-0.5 overflow-hidden",
                        brand.bg,
                      )}
                    >
                  ...
                  >
                    {msg.role === "assistant" && msg.agentType && (
                      <Badge
                        variant="outline"
                        className={cn("mb-1 text-[10px] py-0 h-4", brand.border, brand.text)}
                      >
          ...
          {/* Quick chips */}
          <div
            className={cn("px-4 pt-2 pb-1 flex gap-1.5 flex-wrap border-t border-border shrink-0")}
          >
